...
import pytest
from src.calculator import Calculator, DivisionByZeroError, CalculatorError
...
class TestCalculator:
    ...
    def test_subtract(self, calculator: Calculator, a: float, b: float, expected: float) -> None:
    ...
    def test_multiply(self, calculator: Calculator, a: float, b: float, expected: float) -> None:
    ...
    def test_power(self, calculator: Calculator, base: float, exponent: float, expected: float) -> None:
    ...
    def test_type_hints_work_with_integers_and_floats(self, calculator: Calculator) -> None:
